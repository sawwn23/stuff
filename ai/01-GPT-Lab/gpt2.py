...
class CasualSelfAttention(nn.Module):
    ...
    def forward(self, x):
      B, T, C = x.size() ## B: batch size, T: sequence length, C: embedding dim
...
class MLP(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.gelu = nn.GELU() # use none instead of Tanh from gpt2 paper
...
class GPTConfig:
    ...
    vocab_size: int = 50257 # vocabulary size 50000 BPE + 256 bytes + 1 EOS
